...
uint16_t measure_dist(dist_t dist) {
   ...
   HAL_GPIO_WritePin(emitter_port, emitter_pin, 1);
   //HAL_Delay(5);
   //HAL_GPIO_WritePin(receiver_port, receiver_pin, 1);
   ...
   HAL_GPIO_WritePin(emitter_port, emitter_pin, 0);
   //HAL_GPIO_WritePin(receiver_port, receiver_pin, 0);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, EMIT_R_Pin|EMIT_L_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : EMIT_R_Pin EMIT_L_Pin */
  GPIO_InitStruct.Pin = EMIT_R_Pin|EMIT_L_Pin;
